...
## Discussion Group: Asexuality, Aromanticism and Kink...? 

Our culture generally considers sex and kink to be one and the same, but there is a growing Ace/Aro presence in the BDSM community that is highlighting the many ways in which this is not true. This discussion group allows Aces and Aros to share their interests and experiences in kink, and explore the complex intersection of these distinct identities. Siren Vandoll will moderate and guide the discussion and hopes to use the information provided to inform the BDSM community about the existence of kinky Aces/Aros and develop ways to better include them in kink culture. She is also hoping to develop a factsheet, reader and/or workshop about exploring kink as an Ace/Aro person. This discussion group is designed to give Aces/Aros a voice and attendance should be mindful of that.
